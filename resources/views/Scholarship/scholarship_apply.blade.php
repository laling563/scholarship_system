            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="bi bi-speedometer2 text-muted"></i></span>
        ...
        <div class="card mb-4 border-0 shadow-sm">
            ...
            <div class="card-body">
                ...
                <div id="document-fields">
                    <div class="d-flex gap-3 mb-3 align-items-center document-row">
                        <div class="flex-grow-1">
                            <label class="form-label">Document Type</label>
                            <div class="input-group">
                                <span class="input-group-text bg-light"><i class="bi bi-tag text-muted"></i></span>
                                <input type="text" name="documents[0][document_type]" class="form-control" placeholder="e.g. Birth Certificate, ID">
                            </div>
                        </div>
                        <div class="flex-grow-1">
                            ...
                            <div class="input-group">
                                ...
                                <input type="file" name="documents[0][file]" class="form-control" accept=".pdf,.jpg,.jpeg,.png,.doc,.docx">
                            </div>
                        </div>
                        <div class="pt-4">
                ...
                <button type="button" class="btn btn-outline-primary mt-2" onclick="addDocumentField()">
