                        ...
                        <table class="table table-hover align-middle mb-0" id="scholarshipsTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="text-truncate" style="max-width: 200px;" data-bs-toggle="tooltip" title="{{ $scholarship->description }}">
                                            {{ $scholarship->description }}
                                        </div>
                                    </td>
                                    <td>
                                        <div class="text-truncate" style="max-width: 200px;" data-bs-toggle="tooltip" title="{{ $scholarship->requirements }}">
                                ...
                                <!-- Delete Modal -->
                                <div class="modal fade" id="deleteModal{{ $scholarship->scholarship_id }}" tabindex="-1" aria-labelledby="deleteModalLabel{{ $scholarship->scholarship_id }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            <div class="modal-header border-0">
                                                <h5 class="modal-title text-danger" id="deleteModalLabel{{ $scholarship->scholarship_id }}">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="alert alert-danger">
                                                    ...
                                                    <div class="small">This action cannot be undone and will remove all associated data.</div>
                                                </div>
                                            </div>
