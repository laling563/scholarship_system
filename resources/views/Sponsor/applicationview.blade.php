            ...
            <div class="card mb-4 border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="info-item">
                                <h6 class="text-primary mb-2"><i class="bi bi-person-vcard me-1"></i> Landlord/Landlady</h6>
                    ...
                    <div class="family-member mb-4 pb-3 border-bottom">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="info-item">
                                    <h6 class="text-muted small mb-1">Full Name</h6>
                                    <p class="mb-0">{{ $application->father_first_name }} {{ $application->father_middle_name }} {{ $application->father_last_name }}</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="info-item">
                    ...
                    <div class="family-member mb-4 pb-3 border-bottom">
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="info-item">
                                    <h6 class="text-muted small mb-1">Full Name</h6>
                                    <p class="mb-0">{{ $application->mother_first_name }} {{ $application->mother_middle_name }} {{ $application->mother_last_name }}</p>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="info-item">
                                    ...
                                    <div class="document-card p-3 border rounded h-100">
                                        <div class="d-flex align-items-center mb-2">
                                            ...
                                            <div>
                                                ...
                                                <small class="text-muted">Uploaded: {{ $document->created_at->format('F d, Y h:i A') }}</small>
                                            </div>
                                        </div>
                                        <div class="mt-2">
