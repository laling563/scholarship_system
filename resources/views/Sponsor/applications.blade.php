            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-primary text-white">
                        <h3 class="mb-0"><i class="bi bi-file-earmark-text me-2"></i>Applications (Income ₱10,000 below)
                        </h3>
                    </div>
                                    ...
                                    <tbody>
                                        @foreach($applications->where('total_monthly_income', '<=', 10000) as $application)
                                                                <tr>
                                                                    <td>
                                                                        <div>
                                                                            <h6 class="mb-0">{{ $application->student->fname ?? 'No student' }}
                                                                    ...
                                                                    <td class="text-end pe-4">
                                                                        <div class="d-flex justify-content-end gap-2">
                                                                            ...
                                                                            @if($application->status != 'approved')
                                                                                <form
                                                                                    action="{{ route('sponsor.applications.accept', $application->applicationform_id) }}"
                                                                                    method="POST">
                                                                                    @csrf
                                                                                    @method('PUT')
                                                                                    <button type="submit"
                                                                            ...
                                                                            @if($application->status != 'rejected')
                                                                                <form
                                                                                    action="{{ route('sponsor.applications.reject', $application->applicationform_id) }}"
                                                                                    method="POST">
                                                                                    @csrf
                                                                                    @method('PUT')
                                                                                    <button type="submit"
            ...
            <div class="col-lg-6">
                <div class="card shadow-sm border-0 h-100">
                    <div class="card-header bg-info text-white">
                        <h3 class="mb-0"><i class="bi bi-file-earmark-text me-2"></i>Applications (Income ₱10,000 above)
                        </h3>
                    </div>
                    <div class="card-body p-0 d-flex flex-column">
                        @if($applications->where('total_monthly_income', '>', 10000)->count())
