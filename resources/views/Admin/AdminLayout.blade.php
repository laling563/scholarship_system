        ...
        <nav id="sidebar" class="admin-sidebar">
            ...
            <div class="px-3 py-2 d-flex align-items-center">
                <img src="/images/admin.png"
                    class="rounded-circle me-2" alt="Admin" style="width: 40px; height: 40px; object-fit: cover;">
                <div>
...
<li>
    <a href="{{ route('applications.index') }}" class="{{ request()->routeIs('applications.index') ? 'active' : '' }}">
        <i class="fas fa-file-alt"></i> Applications
            {{-- You can place a count here if needed --}}
        </span>
    </a>
</li>

<li>
    <a href="{{ route('Scholarship.index') }}" class="{{ request()->routeIs('Scholarship.index') ? 'active' : '' }}">
